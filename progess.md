...
- **2026-04-08:** Implemented Cache-Control headers for static assets in `vercel.json`. Added a CI/CD rollback workflow (`.github/workflows/rollback.yml`) enabling instant rollbacks to maintain previous stable states. Authored comprehensive operational runbooks (`docs/runbooks.md`) including incident response, recovery procedures, and an offline mode fallback guide.
