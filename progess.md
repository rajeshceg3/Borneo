...
- **2026-04-07:** Configured backend hosting to Render (`render.yaml`). Implemented operational runbooks (`docs/runbooks.md`). Added Prometheus monitoring to the backend (`express-prometheus-middleware`) and set up a local Grafana + Prometheus stack via Docker Compose. Project completion is approximately 100%.
